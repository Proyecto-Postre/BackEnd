...
public static class SignInCommandFromResourceAssembler
{
    ...
    {
        return new SignInCommand(resource.UsernameOrEmail, resource.Password);
    }
}
...
public static class SignUpCommandFromResourceAssembler
{
    ...
    {
        return new SignUpCommand(resource.Username, resource.Email, resource.Password, resource.FirstName, resource.LastName, resource.Phone);
    }
}
...
public static class AuthenticatedUserResourceFromEntityAssembler
{
    ...
    {
        return new AuthenticatedUserResource(user.Id, user.Username, token, user.Role.ToString().ToLower());
    }
}
